...
def parse_args():
    ...
    parser.add_argument('--gat', action='store_true',
                        help='GAT')
    parser.add_argument('--gat_our', action='store_true',default=False,
                        help='GAT_our')
...
def main():
    ...
    # Bert, load pretrained model and tokenizer, check if neccesary to put bert here  选择bert的tokenizer分词器
    if args.embedding_type == 'bert':
        tokenizer = BertTokenizer.from_pretrained(args.bert_model_dir)
        args.tokenizer = tokenizer

    # Load datasets and vocabs   加载数据集 和词向量
